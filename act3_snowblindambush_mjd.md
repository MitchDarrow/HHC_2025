...
<p>
A basic test to see if SSTI is possible is {% raw %}{{7*7}}{% endraw %}. Because the application evaluates the expression and displays the results on the page, the application is likely vulnerable.
<br>
</p>
<p>
