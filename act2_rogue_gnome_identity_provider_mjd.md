...
Using the first curl command from the notes combined with the credentils to login:
...
```
Create the PEM file using jwk to pem convertor, pem to jwk convert online, jwk openssl format pem
```
